...
# Makes calculator fixed height and width
root.resizable(width=False, height=False)

# Sets the geometry of window
root.geometry("480x568+450+90") 

# Holds buttons in the calculator and creates a grid like pattern of the frame
calc = Frame(root)
calc.grid()
...
# Creates buttons and their effects, such as pi, e, sin, cos, tan
class Calc():
	def __init__(self):
		self.total = 0
		self.current = ''
